...
def build_network(
    ...
    device="cpu"):
    network_type = config.task["network"]["type"]
    ...
    if network_type == "diffusion_scene_layout_ddpm":
        ...
        if 'optimizer' in config:
            ...
            # network.diffusion.diffusion.set_optimizer(optimizer,dataset,cfg, objects_dataset,gapartnet_dataset)
    else:
        raise NotImplementedError()
...
# def create_optimizer(cfg) -> Optimizer:
...
#     return OPTIMIZER.get(cfg.name)(cfg)
